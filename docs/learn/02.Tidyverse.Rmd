...
This slide deck assumes some initial prior basic R knowledge, that can be obtained through numbers of excellent R introductions online for self-studying. 

Every learner has its own learning preference & pace: If you like manual and prefer to start with theory, see [R-intro](https://cran.r-project.org/doc/manuals/R-intro.pdf). If you are more into presentation, see the ones shared in the  [Resource](https://unhcrverse.github.io/unhcrverse/learn/02.Tidyverse.html#54) slide. You may also start below directly and then complement with theory at your own pace...

In this slide deck, we get you in some illustrations of R __specifically applied to UNHCR Context__: 
...
- Basic of the grammar of graphics with [**`ggplot2`**](https://ggplot2.tidyverse.org/index.html) and get your first UNHCR-branded chart with [**`{unhcrthemes}`**](https://unhcr-dataviz.github.io/unhcrthemes/) package
...
Does not display __yet__ any data!! i.e. gray box! 
Without data, you don't have a plot!
]
...
This will bring us the begining of a chart!! 
