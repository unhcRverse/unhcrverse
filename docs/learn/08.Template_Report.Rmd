...
- R Markdown supports various output formats, such as HTML, PDF, and Word documents.
...
## Report Styling
  ...
  * Customize report style using CSS.
  * Change fonts, colors, and layouts.

---

## Branding with {unhcrdown}
...
## Humanitarian Data Product

```{r, echo = FALSE, out.width = "80%"}
knitr::include_graphics("img/humprod_unhcr.svg")
```

---

## Reproducible pipelines with R markdown or Quarto
...
##  Notebook for Data Insights documentation: Analysis Repo
