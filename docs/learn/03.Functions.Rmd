...
# Smae: calculate the mean of a numeric vector
...
Parameters allow customization of function behavior, this means you can get your function to __scale up__ to different context, which makes your 
...
## Now I can share my function!


.pull-left[

It becomes now easy to re-use my function in another operation....
...
## How to access data - beside uisng data embedded in a package like {refugees}
...
->  [next you can start putting your function in a package](10.Package_Knowledge.html)
