...
- Understand what is "__analysis reproducibility__" and what/how you can gain from it. 
...
__In data science, the equivalent of "food safety measures" are also required....__ 
...
**Version control** all custom scripts and  write extensive and easily understandable comments in the code
...
Unless you can justify not to do so, provide **public access** to scripts, runs, and results
...
A __script__ is a set of written code instructions that automates a series of orchestrated tasks. A __function__ is a script that has been factorized to work with a specific input. A __package__ is collection of functions. Using the right combination of packages, all necessary data analysis steps can be recorded into scripts.
...
R is a programming language and a software environment for statistical computing and graphics. The initial version of R has been released in 1997 and the V.1 in 2000!
...
Engineers tend to use Python over R, but R often remains the preferred language of statisticians who needs latest techniques & Algorithm integrated in a report publication workflow.
...
A scripted approach enables, per design, quality peer review. It is easier to find errors in a script than in a click procedure because it allows to check every step of the analysis. If an error is identified, it can quickly be fixed without recreating everything...
...
When enough investment can be made, __Graphical User Interface__ (GUI) can be developed on the top of specific functions. 

This breeds the best of two approaches: Enforcing reproducibility first while still easing the learning curve of new users while they are still in the process of building up their personal skills.
...
(a) start with a script or (b) show the final product and then try to reproduce it...
...
Data wrangling is the process of cleaning and transforming raw data into a __usable format for analysis__.

Data Wrangling takes usually more than __80%__ of any data project time...
...
A package is the most organized way to build and share reproducible analysis.

A package is usually the result of gradual automation in development

 * [step 1](https://unhcrverse.github.io/unhcrverse/learn/02.Tidyverse.html): write a command
 * [step 2](https://unhcrverse.github.io/unhcrverse/learn/03.Functions.html): organize multiple command together as re-usable function
 * [step 3](https://unhcrverse.github.io/unhcrverse/learn/10.Package_Knowledge.html): organize multiple functions together in a package,  includes test data, Documentation & Unit testing
 * [step 4](https://unhcrverse.github.io/unhcrverse/learn/11.Simplify_with_companionApp.html): add a Graphical User Interface (GUI) with Shiny 
 
]
.pull-right[

A package is a folder with a predefined structure: 
...
# How to get started in your learning curve?
...
<span style='font-size:20px; color:grey;'> When you drive your car, you dashboard provides decision-focused information (_aka Key Performance Indicators - KPIs_), to support decisions (_refill the tank, decelerate..._) based on pre-existing knowledge (_the driver has already a license..._)</span>
...
Learn though Question-answers to [AI](https://copilot.microsoft.com/)
