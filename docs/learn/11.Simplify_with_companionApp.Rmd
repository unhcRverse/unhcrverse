...
Shiny is __Graphical User Interface Framework__ designed to interact with back-office functions written in R Statistical Computing Language (and now also [python](https://shiny.posit.co/py/)). It allows you to turn your R/Python code into interactive web apps without the need for web development skills. 
...
Setting up a simple Shiny app is easy enough, but setting up a Shiny app that is scalable and still runs smoothly and fast is a completely different ballgame:
