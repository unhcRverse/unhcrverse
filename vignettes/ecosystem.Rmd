...
> We **DO RECOMMEND** to use [fusen package](https://thinkr-open.github.io/fusen/index.html) to develop packages as it facilitates a lot peer review and enforces a series of good practices (example, unit testing..)
...
`{unhcrverse}` includes packages related to 
 ...
 1. __Design and branding__ such as [unhcrdown](https://github.com/unhcr-dataviz/unhcrdown): UNHCR templates for R Markdown,   [unhcrthemes](https://github.com/unhcr-dataviz/unhcrthemes): UNHCR branded theme for ggplot2 and data visualization colour palettes, 
 
 
 2. __Data Access__ such as [unhcrdatapackage](https://github.com/edouard-legoupil/unhcrdatapackage): Use UNHCR Open data, [ridl](https://github.com/dickoa/ridl): API to connect to internal data source, [robotoolbox](https://github.com/dickoa/robotoolbox): API to connect to Kobo Data Collection Server, [rhdx](https://github.com/dickoa/rhdx): API to connect to Humanitarian Data Exchange and [popdata](https://github.com/PopulationStatistics/popdata): API to connect to the system for official statistic curation


 3. __Survey Data Processing__ such as [HighFrequencyChecks](https://github.com/edouard-legoupil/HighFrequencyChecks/): Perform High Frequency Check or  [kobocruncher](https://github.com/edouard-legoupil/kobocruncher): Process data crunching for survey dataset or [XlsFormUtil](https://github.com/unhcr-americas/XlsFormUtil): to work with multiple xlsform
 ...
 *  [unhcrstyle](https://unhcr-web.github.io/unhcRstyle/docs/) got deprecated by [unhcrdown](https://github.com/unhcr-dataviz/unhcrdown) and  [unhcrthemes](https://github.com/unhcr-dataviz/unhcrthemes)
